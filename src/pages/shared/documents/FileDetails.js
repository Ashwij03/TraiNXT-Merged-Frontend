      ...
      <div className="file-details-page tnxt-compact">
        ...
        <div className="file-card">
          ...
          <div className="file-row">
            <div>
              <p>
                <b>Study:</b> 747-303 OBETICHOLIC ACID (OCA)
              </p>
              <p>
                <b>File Type:</b> Lab Report
              </p>
            </div>

            <div>
              <p>
                <b>Subject:</b> T-S - 123-0001
              </p>
              <p>
                <b>Visit:</b> Visit 1 - Screening 1
              </p>
            </div>
          </div>
              ...
              {[
                ...
                <tr key={index}>
                  <td className="cell-with-annotation">
                    ...
                    <span className="annotation-dot">{index + 1}</span>

                    <div className="annotation-tooltip">{item.note}</div>
                  </td>
