...
export default function DocumentStatusWidget({
  ...
  const statusSummary = summary || getDocumentStatusSummary(documents);
  ...
  return (
    <div className="document-status-widget">
      ...
      <div className="widget-body">
        {statuses.length === 0 ? (
          <div className="widget-empty">No documents available.</div>
        ) : (
            ...
            <div className="status-row" key={status}>
              <div className="status-info">
                <span
                  ...
                  style={{
                    backgroundColor: statusColors[status] || "#2563eb",
                  }}
                />
