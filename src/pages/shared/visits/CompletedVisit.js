    ...
    <div className="visit-container">
      ...
      <div className="card">
        <div className="procedure-header">
          ...
          <button className="plus-btn" onClick={() => toggle("procedure")}>
            +
          </button>
        </div>
        ...
        <div className="question-row">
          <div className="question-left">
            <div className="question-title">Date of Birth</div>
          </div>

          <div className="question-right">
            <div className="question-value">15-JUN-1983</div>

            <div className="question-user">
              Raymond Nomizu, 08-FEB-2017 9:29 AM
            </div>

            <div className="audit-link">view audit trail (2)</div>
          </div>

          <button className="plus-btn" onClick={() => toggle("question")}>
            +
          </button>
        </div>
      ...
      <div className="card">
        ...
        <div className="progress-row">
          ...
          <button className="plus-btn" onClick={() => toggle("progress")}>
            +
          </button>
        </div>
      ...
      <div className="card">
        <div className="procedure-header">
          ...
          <button className="plus-btn" onClick={() => toggle("document")}>
            +
          </button>
        </div>
