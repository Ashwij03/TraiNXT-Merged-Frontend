...
const Settings = () => {
  ...
  const [profilePhoto, setProfilePhoto] = useState(() => {
    ...
    return (
      currentUser?.profilePhoto || localStorage.getItem("profilePhoto") || ""
    );
  });
          ...
          <>
            ...
            <div className="toggle-row">
              ...
              <input
                ...
                onChange={() => update("criticalOnly", !settings.criticalOnly)}
              />
            </div>
            <div className="toggle-row">
              ...
              <input
                ...
                onChange={() =>
                  update("enrollmentAlerts", !settings.enrollmentAlerts)
                }
              />
            </div>
            <div className="toggle-row">
              ...
              <input
                type="checkbox"
                checked={settings.regulatoryAlerts}
                onChange={() =>
                  update("regulatoryAlerts", !settings.regulatoryAlerts)
                }
              />
            </div>
          </>
          ...
          <>
            ...
            <div className="toggle-row">
              ...
              <input
                ...
                onChange={() =>
                  update("twoFactorEnabled", !settings.twoFactorEnabled)
                }
              />
            </div>
            <div className="toggle-row">
              ...
              <input
                ...
                onChange={() =>
                  update("sessionTimeout", !settings.sessionTimeout)
                }
              />
            </div>
          </>
          ...
          <>
            <div className="form-group">
              ...
              <select
                ...
                onChange={(e) => update("defaultStudyView", e.target.value)}
              >
            ...
            <div className="form-group">
              ...
              <select
                ...
                onChange={(e) => update("dashboardRefresh", e.target.value)}
              >
            ...
            <div className="form-group">
              ...
              <select
                value={settings.preferredTherapeuticArea}
                onChange={(e) =>
                  update("preferredTherapeuticArea", e.target.value)
                }
              >
            ...
            <div className="toggle-row">
              ...
              <input
                type="checkbox"
                checked={settings.showCompletedStudies}
                onChange={() =>
                  update("showCompletedStudies", !settings.showCompletedStudies)
                }
              />
            </div>
          </>
    ...
    <AppLayout>
      <div className="settings-page">
        <div className="sponsor-page-header">
          <h1>Settings</h1>
          <p>
            Configure your sponsor portal preferences, security, and study
            display options.
          </p>
        </div>
          ...
          {SECTIONS.map((section) => {
            ...
            return (
              <div
                ...
                tabIndex={0}
                onKeyDown={(e) =>
                  e.key === "Enter" && setActiveSection(section.id)
                }
              >
                <div
        ...
        <div className="settings-summary-card">
          ...
          <div className="settings-summary-grid">
            ...
            <div>
              <span>Refresh</span>
              <strong>{settings.dashboardRefresh} min</strong>
            </div>
            <div>
              <span>Study View</span>
              <strong>{settings.defaultStudyView}</strong>
            </div>
          </div>
        </div>
      </div>
