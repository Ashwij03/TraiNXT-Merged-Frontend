...
const PortfolioManagement = () => {
  ...
  const filteredStudies = studies.filter((study) => {
    ...
    const matchesStatus =
      statusFilter === "All Studies" || study.status === statusFilter;
  ...
  return (
    <AppLayout>
      <div className="page-container tnxt-compact">
        ...
        <div className="sponsor-kpi-grid">
          <KpiCard
            ...
            iconBg="#eff6ff"
            iconColor="#2563eb"
            onClick={() => setStatusFilter("All Studies")}
          />
          <KpiCard
        ...
        <div className="portfolio-actions sponsor-toolbar">
          ...
          <button
            type="button"
            className="sponsor-btn-primary create-study-btn"
            onClick={() => {
              setEditStudy(null);
              setForm({
                studyId: "",
          ...
          <table className="sponsor-table portfolio-table ctms-standard-table">
            ...
            <tbody>
              {filteredStudies.map((study) => (
                <tr
                  key={study.studyId}
                  onClick={() => navigate(`/portfolio/${study.studyId}`)}
                >
                  <td>{study.studyId}</td>
                  ...
                  <td>{study.sites}</td>
                  <td>
                    {study.enrolled || 0} / {study.target || 0}
                  </td>
                  <td
                  ...
                  >
                    <button
                      ...
                      onClick={() =>
                        navigate(
                          `/study-dashboard/${study.studyId}?tab=Overview`,
                        )
                      }
                    >
                      View
      ...
      {showCreateModal && (
        <EnterpriseModal
          title={editStudy ? "Edit Study" : "Create Study"}
          onClose={() => setShowCreateModal(false)}
          onSave={handleSave}
          saveLabel={editStudy ? "Update" : "Create"}
        >
          <input
