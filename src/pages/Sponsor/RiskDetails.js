...
const RiskDetails = () => {
  ...
  const [riskStatus, setRiskStatus] = useState(docData?.status || "Open");
  ...
  if (!risk) {
    return (
      <AppLayout>
        <div
          style={{ padding: "24px" }}
          className="risk-details-page tnxt-compact"
        >
  ...
  const exportData = () => {
    const csvData = `RiskID,Study,Category,Severity,Status
${risk.id},
${risk.study},
${risk.category},
${risk.severity},
${risk.status}`;
  ...
  const handleResolveRisk = () => {
    ...
    alert(`Risk ${risk.id} has been successfully resolved`);
  };
      ...
      <div className="page-container">
        ...
        <div className="details-card">
          ...
          <table className="metrics-table ctms-standard-table">
            ...
            <tbody>
              ...
              <tr>
                <td>Closure</td>
                <td>{riskStatus === "Resolved" ? "Completed" : "Pending"}</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="details-card">
          ...
          <div className="action-buttons">
            ...
            >
              {riskStatus === "Resolved" ? "Risk Resolved" : "Resolve Risk"}
            </button>
