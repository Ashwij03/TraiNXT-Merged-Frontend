...
const RecruitmentDetails = () => {
  ...
  const generateReport = () => {
    ...
    doc.text(`Study: ${studyData.study}`, 20, 40);

    doc.text(`Target: ${studyData.target}`, 20, 50);

    doc.text(`Enrolled: ${studyData.enrolled}`, 20, 60);

    doc.save("RecruitmentReport.pdf");
  };

  const exportData = () => {
    const csvData = `Study,Target,Enrolled
${studyData.study},
${studyData.target},
${studyData.enrolled}`;
    ...
    a.download = "RecruitmentData.csv";
      ...
      <div className="page-container tnxt-compact">
        ...
        <div className="kpi-grid">
          ...
          <div className="kpi-card">
            <h3>Recruitment %</h3>
            <h2>
              {Math.round((studyData.enrolled / studyData.target) * 100)}%
            </h2>
          </div>
        </div>
        ...
        <div className="details-card">
          ...
          <table className="sponsor-table ctms-standard-table">
            ...
            <tbody>
              <tr>
                <td>
                  {resolveSiteDisplay("Apollo Hospital", {
                    sources: getStudies(),
                  })}
                </td>
                <td>500</td>
              ...
              <tr>
                <td>
                  {resolveSiteDisplay("Care Hospital", {
                    sources: getStudies(),
                  })}
                </td>
                <td>400</td>
              ...
              <tr>
                <td>
                  {resolveSiteDisplay("Metro Hospital", {
                    sources: getStudies(),
                  })}
                </td>
                <td>350</td>
        ...
        <div className="details-card">
          ...
          <div className="action-buttons">
            ...
            <button onClick={exportData}>Export Recruitment Data</button>

            <button
              onClick={() =>
                alert(
                  "Recruitment notification sent to all participating sites",
                )
              }
            >
              Notify Sites
