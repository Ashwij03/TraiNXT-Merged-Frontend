...
function Screening() {
  ...
  const filteredScreenings = screenings.filter((screening) => {
    const matchesSearch = screening.id
      .toLowerCase()
      .includes(searchTerm.toLowerCase());

    const matchesSite =
      selectedSite === "All Sites" || screening.site === selectedSite;

    const matchesStatus =
      selectedStatus === "All Status" || screening.status === selectedStatus;
    ...
    <AppLayout>
      <div className="screening-page tnxt-compact">
        ...
        <div className="screening-card">
          <p>Total Records: {filteredScreenings.length}</p>
        ...
        {selectedScreening && (
          <div className="modal-overlay">
            <div className="modal-content">
              ...
              <p>Age Criteria: {selectedScreening.ageCriteria}</p>

              <p>Consent Signed: {selectedScreening.consent}</p>

              <p>Medical History: {selectedScreening.medicalHistory}</p>

              <p>Lab Results: {selectedScreening.labResults}</p>
